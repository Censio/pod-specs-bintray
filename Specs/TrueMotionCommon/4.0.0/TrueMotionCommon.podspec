Pod::Spec.new do |spec|
	...
	spec.source  = { :http => "https://censio.bintray.com/generic/TrueMotionCommon/TrueMotionCommon-4.0.0.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCommon.framework"
    spec.dependency 'RealmSwift', '~> 10.1'
    spec.dependency 'Realm', '~> 10.1'
    spec.dependency 'TrueMotionCore', '~> 5.2'
    spec.dependency 'TrueMotionInternal', '~> 5.2'
end