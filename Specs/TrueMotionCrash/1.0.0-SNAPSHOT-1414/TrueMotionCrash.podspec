Pod::Spec.new do |spec|
	...
	spec.version = "1.0.0-SNAPSHOT-1414"
	...
	spec.source  = { :http => "https://github.com/Censio/pod-specs-bintray/TrueMotionCrash/TrueMotionCrash-1.0.0-SNAPSHOT-1414.tar.gz" }
	spec.vendored_frameworks = "TrueMotionCrash.framework"
	spec.dependency 'TrueMotionCore', '1.4.1'
	spec.dependency 'TrueMotionCommon', '1.0.0-SNAPSHOT-1414'
end