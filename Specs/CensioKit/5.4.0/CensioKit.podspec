Pod::Spec.new do |s|
  ...
  s.platform = :ios, "11.0"
  s.requires_arc = true
  s.source = { :http => "https://censio.bintray.com/generic/CensioKit/CensioKit-5.4.0.tar.gz" }
  ...
  s.dependency 'TrueMotionCore', '~> 2.6'
  s.dependency 'TrueMotionSensorEngineAdapter', '~> 1.20'
end
