Pod::Spec.new do |s|
  ...
  s.platform = :ios, "11.0"
  s.requires_arc = true
  s.source = { :http => "https://censio.bintray.com/generic/CensioKit/CensioKit-5.0.1.tar.gz" }
  ...
  s.dependency 'TrueMotionCore', '~> 1.7'
  s.dependency 'TrueMotionSensorEngineAdapter', '~> 1.0'
end